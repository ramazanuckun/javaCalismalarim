...
public class C05_MdaSonElamanlariCarpimi {
...
int carpim=1;
        ...
        System.out.println("son elamanlarin carpimi" + carpim);//hepsinin carpimi olsa idi if koymadan direk carpim derdik ve bulurduk
