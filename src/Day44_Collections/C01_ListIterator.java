    ...
    public static void main(String[] args) {
       ...
       */
       List<Integer> liste =new ArrayList<>();
        ...
        int basSinir=20;
        int bitisSinir=40;
       while (li1.hasNext()){////yaninda elaman oldugu surece calisacak
Integer temp=(Integer) li1.next();//satirin onemi iki kere ilerlememek icin
           if (temp<basSinir || temp>bitisSinir){

               li1.remove();//yukari geziyor bura siliyor
           }
